...
![Desktop View](/assets/img/5/1.png){: width="700" height="200" }
_sentry에서 확인되던 오류_
...
그래서 연결에 관해 이에 도움이 될 수 있는 옵션들을 찾다보니 pool_pre_ping[^1] 과 pool_recycle[^2]을 찾았다. 
...
![Desktop View](/assets/img/5/2.png){: width="700" height="200" }

테스트 환경에서 확인해본 뒤에 상용 환경에 배포하였다. 
![Desktop View](/assets/img/5/3.png){: width="700" height="200" }
